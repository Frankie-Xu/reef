...
class AdapterDescriptor:
    ...
    prompt_is_task_directory: bool = False
...
def load_descriptor(path: Path) -> AdapterDescriptor:
    ...
    prompt_is_task_directory = data.get("prompt_is_task_directory", False)
    if not isinstance(prompt_is_task_directory, bool):
        raise DescriptorError(f"{where} 'prompt_is_task_directory' must be a boolean")
    ...
    return AdapterDescriptor(
        ...
        prompt_is_task_directory=prompt_is_task_directory,
